...
import { comparePasswords, create, findUserByUsernameWithPassword, getUserById } from '../db/models/users'
const router = express.Router();

router.use(express.json());
router.post('/register', async (req, res) => {
    const { username, name, last_name, mail, password, repeat_password } = req.body;
